      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl bg-white px-8 py-10 shadow-xl ring-1 ring-slate-100">
        ...
        <div className="space-y-2 text-center">
          <h1 className="text-2xl font-semibold text-blue-700">
            {t('login.manager_title', 'Manager Login')}
          </h1>
          <p className="text-sm text-slate-500">
            {t('login.manager_subtitle', 'Access your nursery management dashboard')}
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-2xl border-slate-200 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-slate-50 disabled:cursor-not-allowed"
