      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl bg-white px-8 py-10 shadow-xl ring-1 ring-slate-100">
        ...
        <div className="space-y-2 text-center">
          <h1 className="text-2xl font-semibold text-green-700">
            {t('login.supervisor_title', 'Supervisor Login')}
          </h1>
          <p className="text-sm text-slate-500">
            {t('login.supervisor_subtitle', 'Access your classroom management dashboard')}
          </p>
        </div>
        ...
        >
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-2xl border-slate-200 text-sm shadow-sm focus:border-green-500 focus:ring-green-500 disabled:bg-slate-50 disabled:cursor-not-allowed"
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-full bg-green-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-500"
          ...
          <div className="text-center space-y-2">
            ...
            <div className="flex justify-center space-x-4 text-xs text-slate-500">
              ...
              <span>|</span>
              <a href="/parent-login" className="hover:text-slate-700 transition">Parent</a>
            </div>
          </div>
        </form>
      </div>
