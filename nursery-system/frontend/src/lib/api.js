...
export const nurseryAPI = {
  ...
  // Classrooms
  getClassrooms: (branchId, params) => apiClient.get(`/admin/branches/${branchId}/classrooms`, { params }),
  createClassroom: (branchId, data) => apiClient.post(`/admin/branches/${branchId}/classrooms`, data),
  getClassroom: (branchId, classroomId) => apiClient.get(`/admin/branches/${branchId}/classrooms/${classroomId}`),
  updateClassroom: (branchId, classroomId, data) => apiClient.put(`/admin/branches/${branchId}/classrooms/${classroomId}`, data),
  deleteClassroom: (branchId, classroomId) => apiClient.delete(`/admin/branches/${branchId}/classrooms/${classroomId}`),
};
